...
#   cd $db_bench
  rm -rf $db_bench
  /usr/local/bin/cmake --no-warn-unused-cli -DCMAKE_EXPORT_COMPILE_COMMANDS:BOOL=TRUE -DCMAKE_BUILD_TYPE:STRING=Release -DCMAKE_C_COMPILER:FILEPATH=/usr/bin/gcc -DCMAKE_CXX_COMPILER:FILEPATH=/usr/bin/g++ -S/home/wzh/SLM-DB -B/home/wzh/SLM-DB/build -G Ninja
  cmake --build $db_bench --config Release --target all --parallel --
